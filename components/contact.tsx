            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-amber-600">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <a href="mailto:contact@michumediumclinic.com" className="text-gray-700 text-lg hover:text-amber-600 transition-colors">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/drsegnimichuMC" target="_blank" rel="noopener noreferrer" className="text-gray-700 text-lg hover:text-amber-600 transition-colors">
                    @drsegnimichuMC
                  </a>
                </div>
              </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-amber-600">
            ...
            <div className="w-full h-96 bg-gray-200 rounded-lg flex items-center justify-center border-2 border-gray-300">
              <div className="text-center">
                ...
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3942.5029999999995!2d40.3!3d9.3!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOcKwMTgnMDAiTiA0MMKwMTgnMDAiRQ!5e0!3m2!1sen!2set!4v1234567890"
                  width="100%" 
                  height="100%" 
